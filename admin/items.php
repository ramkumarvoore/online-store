...
<script>
 function admin_func(){
	 ...
	 if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
	  ...
	  xmlhttp.open('GET', 'itemphp.php', true);
      xmlhttp.send();
  ...
  function del_func(item_id){
	 ...
	 if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
	  ...
	  xmlhttp.open('GET', 'itemphp.php?del_item_id='+item_id, true);
      xmlhttp.send();
  ...
  function edit_form(){
	...
	item_delivery=document.getElementById('item_delivery').value;
	 ...
	 if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
	  ...
	  xmlhttp.open('GET', 'itemphp.php?up_item_id='+item_id+'&item_title='+item_title+'&item_description='+item_description+'&item_cat='+item_category+'&item_qty='+item_qty+'&item_cost='+item_cost+'&item_price='+item_price+'&item_discount='+item_discount+'&item_delivery='+item_delivery, true);
      xmlhttp.send();
